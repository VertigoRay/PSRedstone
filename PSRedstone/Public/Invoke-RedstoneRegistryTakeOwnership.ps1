...
function Invoke-RedstoneRegistryTakeOwnership {
    ...
    Write-Information ('[Invoke-RedstoneRegistryTakeOwnership] > {0}' -f ($MyInvocation.BoundParameters | ConvertTo-Json -Compress))
    Write-Debug ('[Invoke-RedstoneRegistryTakeOwnership] Function Invocation: {0}' -f ($MyInvocation | Out-String))
